  ...
  <div>
    ...
    <div class="container" v-if="!showEdit">
      ...
      <my-table
        ...
        v-loading="loading"
      ></my-table>
      <table-paper :currPageNum="index" :PagerOrder="totalPage" @tablePaperEven="tablePaperChange"></table-paper>
    </div>
  ...
  methods: {
    ...
    async getArticles() {
      try {
        ...
        this.totalPage = Number(articles.total)
