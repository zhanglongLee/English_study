<template>
  <div class="container">
    ...
    <div class="wrap">
      <el-row>
        <el-col :span="24">
          <el-form :model="form" :rules="rules" status-icon ref="form" label-width="110px" v-loading="loading" @submit.native.prevent>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        image: [
          { required: true, message: '请输入文章封面图', trigger: 'change' },
        ],
        content: [
        ...
        is_published: [
          { type: 'date', required: true, message: '请选择发布状态', trigger: 'change' }
        ],
        is_comment_enabled: [
          { type: 'date', required: true, message: '请选择评论状态', trigger: 'change' }
        ],
        is_top: [
          { type: 'date', required: true, message: '请选择置顶状态', trigger: 'change' }
        ],
      }
    }
  },
