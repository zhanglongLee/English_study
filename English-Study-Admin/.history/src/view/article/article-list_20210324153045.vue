  ...
  methods: {
    ...
    async getArticles() {
      try {
        ...
        // 处理布尔值显示
        this.tableData.show_is_published = !!this.tableData.is_published ? '是' : '否'
        this.tableData.show_is_comment_enabled = !!this.tableData.is_comment_enabled ? '是' : '否'
        this.tableData.show_is_top = !!this.tableData.is_top ? '是' : '否'
