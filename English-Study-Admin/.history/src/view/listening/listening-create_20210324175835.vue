      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            <el-col :span="24">
              <el-col :span="12"><div class="questions-title">听力练习题目及答案解析:</div></el-col>
              <el-col :span="12"><el-button type="primary">添加</el-button></el-col>
              <!-- <el-form-item label="" prop="questions">
                <el-col :span="12">
                  <el-form-item label="练习的问题">
                    <el-input size="medium" v-model="questionsObj.title" placeholder="请填写题目"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="练习的答案">
                    <el-input size="medium" v-model="questionsObj.answer" placeholder="请填写答案"></el-input>
                  </el-form-item>
                </el-col>
              </el-form-item> -->
            </el-col>
