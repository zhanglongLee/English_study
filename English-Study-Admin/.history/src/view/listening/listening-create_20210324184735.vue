        ...
        >
          ...
          <el-card class="box-card" v-for="( item , index ) in questionsList" :key="index">
            <div slot="header" class="clearfix">
              ...
              <el-button @click="questionsList.push(questionsObj)" style="float: right; padding: 3px 0; margin-left:30px;" type="text">添加</el-button>
              <el-button v-if="questionsList.length>1" @click="questionsList.splice(index,1)" style="float: right; padding: 3px 0" type="text">删除该题</el-button>
            </div>
            <el-col :span="11">
